...
// env読み込み
if (env('TOORY') === 'production') {
    Configure::load('env', 'default', true);
} else {
    Configure::load('env_dev', 'default', true);
}
 ...
 */
	...
	Configure::write('debug', Configure::read('debug'));
 ...
 */	Configure::write('Security.salt', Configure::read('salt'));

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */	Configure::write('Security.cipherSeed', Configure::read('seed'));
